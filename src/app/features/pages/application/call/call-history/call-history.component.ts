...
import { apiResultFormat, breadCrumbItems, callHistory } from '../../../../../core/models/models';
...
@Component({
    ...
    imports: [RouterLink, FooterComponent, CustomPaginationComponent, MatSortModule, FormsModule, BsDatepickerModule]
})
