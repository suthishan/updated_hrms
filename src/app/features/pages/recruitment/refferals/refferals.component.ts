...
import { apiResultFormat, breadCrumbItems, ReferralInfo, pageSelection } from '../../../../core/models/models';
...
@Component({
    ...
    imports: [BreadcrumbsComponent, CollapseHeaderComponent, CustomPaginationComponent, FooterComponent, MatSortModule, FormsModule]
})
