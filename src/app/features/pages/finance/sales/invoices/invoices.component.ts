...
import { apiResultFormat, breadCrumbItems, InvoiceList, pageSelection } from '../../../../../core/models/models';
...
@Component({
    ...
    imports: [CommonModule,RouterLink,FormsModule,MatSortModule,
      CustomPaginationComponent,CollapseHeaderComponent,BreadcrumbsComponent,BsDatepickerModule]
})
