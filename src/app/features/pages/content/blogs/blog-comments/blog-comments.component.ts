...
import { apiResultFormat, blogComments, breadCrumbItems } from '../../../../../core/models/models';
...
import { BreadcrumbsComponent } from '../../../../../shared/breadcrumbs/breadcrumbs.component';import { BsDatepickerModule } from 'ngx-bootstrap/datepicker';
;
...
@Component({
    ...
    imports: [CustomPaginationComponent, MatSortModule, FormsModule, CollapseHeaderComponent, BreadcrumbsComponent, BsDatepickerModule]
})
